...
***
* 사업은 해야지 하고 하는 것이 아닌 거 같다.     
  그냥 문제가 있고, 내 나름대로 문제를 해결하는     
  과정에서 사람들과 함께 간다면 그게 사업이지 않을까?     
  
  내가 내리는 사업의 정의는 그렇다. 사업은 한다고      
  하는 것이 아니다. 정말 그 누구도 사업 해야지 하고    
  시작한 사람은 못봤다. 이제껏. 그냥 내가 하고 있는 것을     
  내가 해결하고 있는 문제를 사람들이 좋아해 주고, 같이      
  참여해 가면서 사업적 형태를 띄게 되는 것 같다.         
  
* 이렇게 되면 나는 일단 좋은 개발자, 실력있는 개발자가     
  되는 것이 가장 중요하고, 내가 정의한 실력 있는 개발자는     
  기본이 되어 있는 개발자이다. 기본의 중요성은 너무나도      
  뼈저리게 알기에 프로그래밍의 기본을 제대로 다시 공부하는데     
  시간을 투자하는 것이 좋을 거 같다.      
  
  기본만 되어 있다면 기술을 쌓는 것은 쉽다. 기본을 하는 것이     
  어려운 것이고, 이 기본을 탄탄하게 쌓는 것이 어려운 것이다.        
  기본 위에 기술이 있는 것이다. 기본과 기술을 잘 구분할 필요가     
  있을 거 같다. 요즘엔 "이건 기본이지" 하는 것들 중 기술인 경우가      
  굉장히 많다. 정말 기본은 오히려 간과되고, 언급되지 않는 경우가 있다.      
  
  왜 그럴까 보면 어렵다. 접하기 힘들고, 배우기 힘들다.      
  하지만 기본이라는 것은 변하지 않는다. 그리고 변하지     
  않기 때문에 기본인 것이다. 반짝 하는 기술이 단지      
  많이 쓰인다고 기본이 될 수는 없다. 기본은 변하지 않는다.      
  
  그리고 이 변하지 않는 기본을 잘 닦아 깊게 뿌리내리기 위해        
  가장 시간을 써야 한다. 나무를 배기 위해 날을 가는 행위가     
  기본에 해당하는 듯 하다. 또한 모소대나무가 자라기 위해      
  4년이 넘는 기간동안 단단히 뿌리만 내리는 것이 기본을     
  닦는 행동이다. 기본을 닦는 것은 쉽지 않다.         
  
* 하지만 쉽지 않기 때문에, 그리고 지금, 남들이 하지 않기 때문에      
  나는 더더욱 해야 하고, 시간을 투자해야 한다. 기본을 닦기 위해.     
  기본과 기술을 나누고, 본질을 아는데 시간을 투자하며, 기본을      
  갈고 닦아 기술을 심을 수 있는 비옥한 토양을 만들자.       
***
* 기본을 갈고 닦는 것은 대탐소실 하는 시간을 버는 행위인 거 같다.      
  지금 당장은 늦어 보여도, 기본이 잡혀 있는 사람은 앞으로 치고     
  나갈 때 확실히 치고 나가 올라갈 수 있다.       
  
  시간이란 앞으로 가는 성질을 가지고 있기 때문에     
  뒤로 돌아 가려고 한다면 이제껏 지나온 시간 + 관성이 작용한다.     
  그렇기 때문에 내가 지나온 시간의 2배 이상 투자해야 할 수 있다.     
  
  내가 지금 만들고 싶은 것은 결국 조급함의 일종이다.      
  충분히 기본을 닦아도 해봐야 1년이고, 이 1년 동안    
  닦아 놓은 기본은 내가 닿고자 하는 곳에 5년은 빠르게     
  닿을 수 있게 해줄 것이다 .       
  
  그리고 나 역시 좋은 개발자, 기본 있는, 근본 있는 개발자가 되고 싶다.       
  이게 진짜 지금 나한테 맞는 거 아닐까? 성향상, 그리고 내가 가고자     
  하는 방향상 지금 이 방향이 옳지 않을까?       
  
  정말 치열하게 고민해도, 지금 기본을 닦아 놓지 않으면    
  앞으로 내가 얻을 수많은 기회들이 나를 지나칠 거 같은    
  생각이 든다. 실력있는 개발자, 능력있는 개발자로 성장해         
  사업을 하고, 세상을 바꾸는 사람이 되는 편이 지금 내가     
  진정 원하고, 또 가야할 길이 아닐까?      
 
  혹시 모르니까 좀 더 고민해보자. 충분히 고민해보자.      
  더는 시간낭비 하지 않기 위해      
  다시 강조하지만 되돌아 오는 비용이, 천천히 가는 비용보다    
  2배, 아니 그 이상 크다. 그리고 이 비용은 온전히 낭비다.      
  너무 늦으면 돌이킬 수 없을지 모른다. 기본 없는 축구선수처럼.        
